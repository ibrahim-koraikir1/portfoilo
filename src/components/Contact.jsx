...
export default function Contact() {
  return (
    <div>
      <div className="max-w-5xl mx-10 md:mx-auto text-black h-screen flex flex-col">
        ...
        <div className="flex justify-center items-center my-3 text-xl">
          <span>
            <FiPhoneCall />
          </span>
          <a href="tel: +2130667460451"> +2130667460451</a>
        </div>
        <div className="flex flex-wrap justify-center gap-16  pb-14">
          <a
            href="https://github.com/ibrahim-koraikir1/"
